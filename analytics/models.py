...
class InstallationCount(BaseCount):
    ...
    class Meta(object):
        unique_together = ("property", "end_time", "interval", "subgroup")
...
class RealmCount(BaseCount):
    ...
    class Meta(object):
        unique_together = ("realm", "property", "end_time", "interval", "subgroup")
...
class UserCount(BaseCount):
    ...
    class Meta(object):
        unique_together = ("user", "property", "end_time", "interval", "subgroup")
...
class StreamCount(BaseCount):
    ...
    class Meta(object):
        unique_together = ("stream", "property", "end_time", "interval", "subgroup")
