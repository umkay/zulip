...
# This query violates the count_X_by_Y_query convention in several ways. One,
...
# the subgroup 'message_type' is filled in for the subgroup column.
...
COUNT_STATS = {
    ...
    'message_sent_by_type_by_user': CountStat('messages_sent_by_type_by_user', zerver_count_message_type_by_user, {},
                                              (UserProfile, 'is_bot'), CountStat.DAY, False)}
